...
<body onload="window.print()">
    ...
    <div class="header">
        ...
        <div class="meta">
            <div class="meta-title">Laporan Data Jurusan</div>
    ...
    <div class="summary">
        <div class="summary-box">
            ...
            <div class="value">{{ count($jurusan) }}</div>
        </div>
        ...
        <tbody>
            @foreach ($jurusan as $item)
                <tr>
                    ...
                    <td class="td-nama_jurusan">{{ $item->nama_jurusan }}</td>
                    <td class="td-akreditasi">{{ $item->akreditasi }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
